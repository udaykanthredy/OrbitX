(function ($) {
    ...
    PreLoad.DEFAULTS = {
        order: 'unordered', // unordered preloading
        each: null, // called after each image loads
        all: null // called after all images load
    };
    ...
    PreLoad.prototype._unordered = function () { // unordered loading
